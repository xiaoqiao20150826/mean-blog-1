...
var posts=angular.module("posts",["ngMessages","ngFileUpload"]),PublishController=function(o,l){o.submitted=!1,o.submitForm=function(){o.publishForm.$valid?l({method:"POST",url:"/posts/publish",data:{title:o.publish.title,content:o.publish.content}}).success(function(l){l.result===!0?window.location="/":o.publishForm.content.$setValidity("confirm",!1)}).error(function(o){console.log(o)}):o.publishForm.submitted=!0}},UploadController=function(o,l){o.$watch("files",function(){o.upload(o.files)}),o.log="",o.uploadeds=[],o.upload=function(t){if(t&&t.length)for(var n=0;n<t.length;n++){var s=t[n];l.upload({url:"/posts/upload",file:s}).progress(function(l){var t=parseInt(100*l.loaded/l.total);o.log="progress: "+t+"% "+l.config.file.name+"\n"}).success(function(l,t,n,s){o.uploadeds.push(l)})}}};PublishController.$inject=["$scope","$http"],UploadController.$inject=["$scope","Upload"],posts.controller("PublishController",PublishController),posts.controller("UploadController",UploadController);
